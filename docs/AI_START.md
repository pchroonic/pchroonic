...
- Current main/product merge: `95cda91adb2fe7276f49a73d8626f97d87c2521e` (PR #102 Payment Receipt Tracking); PR #103 records the verified release state.
...
- Customer Stripe remains OFF: production has zero `site_settings` rows with key `payments`; payment policy is inactive.
...
## Stripe live readiness — LIVE ACCOUNT READY / WEBSITE ACTIVATION STILL OFF
