...
module.exports=async function handler(req,res){
  try{
    ...
    if(req.method==='POST'){
      ...
      await auditLog(req,staff,{action:'booking.create',entityType:'booking',entityId:booking.id,summary:`Created booking for ${quote.customer_name||'customer'}`,after:booking,metadata:{quoteId:quote.id}});
