...
module.exports=async function handler(req,res){
  try{
    ...
    await auditLog(req,staff,{action:'booking.economics',entityType:'booking',entityId:bookingId,summary:'Updated direct job costs and travel',before,after,metadata:{quoteId:booking.quote_id||null}});
